...
<body>
<h1 id="welcome">登录成功!,欢迎您:${sessionScope.myUser.realname}</h1>
<a id="order" href="main/allOrder">查看订单</a>
<a id="info" href="main/uinfo?uid=${sessionScope.myUser.userid}&page=${page}">个人信息</a>
...
<script>
    $(function(){
        var user = "${sessionScope.myUser}";
        if(!user){//为空时,user=""、user=null、user = undefined、user=0
